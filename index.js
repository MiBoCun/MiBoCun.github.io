...
let introduceChinese="你好 我是一名来自中国深圳的前端开发工程师.我喜欢运动，擅长跑步和桌球。米柏存是我的曾用名,如果我们有幸认识成为朋友，那么你会知道我的真实名字。业余时间我不会不断更新我的gitHub,同时浏览最新的话题。欢迎互相关注,如果收到你的关注，我会第一时间浏览你的个人博客。最近我在持续关注vue.js&vue-router&vuex，以及前端组件化开发思想。 以上这段英文介绍是我使用百度翻译软件翻译，如果有理解不对，欢迎指正。对了，新冠病毒现在全球蔓延，希望远方的你安然无恙，继续心怀理想。";
